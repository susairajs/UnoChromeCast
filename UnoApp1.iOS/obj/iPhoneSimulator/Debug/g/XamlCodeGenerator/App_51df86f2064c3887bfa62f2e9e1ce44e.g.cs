...
namespace UnoApp1
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
				private void InitializeComponent()
		{
			...
			.GenericApply((c0 => 
			{
				// Source /Users/delpinsusairaj/Projects/UnoApp1/UnoApp1.Shared/App.xaml (Line 1:2)
			...
			global::UnoApp1.GlobalStaticResources.Initialize();
			global::UnoApp1.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::UnoApp1.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::UnoApp1.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ../../../../../../UnoApp1.Shared/App.xaml (Line 1:2)
		}
...
namespace UnoApp1
{
	static class App_51df86f2064c3887bfa62f2e9e1ce44eXamlApplyExtensions
	{
	}
}
